...
class Ui(object):
    ...
    #Aplicar o texto dos botões
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.label.setText(_translate("MainWindow", "CS:GO"))
        self.abates.setText(_translate("MainWindow", "Abates"))
        self.adr.setText(_translate("MainWindow", "Adr"))
        self.mapas.setText(_translate("MainWindow", "Mapas"))
        self.rating.setText(_translate("MainWindow", "Rating"))
        self.impacto.setText(_translate("MainWindow", "Impacto"))
        self.tk.setText(_translate("MainWindow", "tk/tm"))
        self.info.setText(_translate("MainWindow", "Mostrar informações"))
        self.arquivocsv.setText(_translate("MainWindow", "Selecionar o arquivo csv"))
        self.label_2.setText(_translate("MainWindow", "Counter Strike: Graphic Overview"))
